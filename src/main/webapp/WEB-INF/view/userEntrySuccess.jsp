<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- /webapp/WEB-INF/view/userEntrySuccess.jsp --%>    
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
    
<!DOCTYPE html><html><head>
<meta charset="UTF-8">
<title>사용자 등록 결과 화면</title></head>
<body><h2>사용자 등록 결과 화면</h2>
<table border="1" style="border-collapse: collapse;">
  ...
  <tr><td>생년월일</td>
  <td><fmt:formatDate value="${user.birthday}"  pattern="yyyy년 MM월 dd일" /></td></tr>
</table></body></html>